...
def poly_to_vec(polynomial, n=0, degree=0):
    '''
    Convert a polynomial into its vector representation based on a monomial basis.
...
def symmalg(generators, n=0):
    '''
    Compute the symmetry Lie algebra of an ideal generated by the given polynomials.
